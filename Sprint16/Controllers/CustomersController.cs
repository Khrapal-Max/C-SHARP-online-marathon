...
namespace TaskShoppingSystemEF.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ShoppingSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Address,GradeDiscount")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address,GradeDiscount")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
